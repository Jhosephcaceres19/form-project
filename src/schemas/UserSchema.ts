...
export const UserSchema = z
  .object({
    ...
    confimrPasswornd: z.string().min(6, "Debe tener almenos 6 caracteres"),
  })
  .refine((data) => data.password === data.confimrPasswornd, {
...
export const dafaultValues: UserSchemaType = {
  name: " ",
  email: " ",
  password: " ",
  confimrPasswornd: " ",
